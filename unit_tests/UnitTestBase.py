...
class UnitTestBase:
    ...
    def __init__(self, log_name, args):
        ...
        self.parser = argparse.ArgumentParser(
            description="Sanity Testing on Firmware Build", parents=[args])
        ...
        self.parser.add_argument('--skip-update-firmware',
                                 dest='update_firmware', action='store_false')
        ...
        # was os.getenv('CLOUD_SDK_URL')
        self.cloudSDK_url = self.command_line_args.sdk_base_url
        # was os.getenv('SANITY_LOG_DIR')
        self.local_dir = self.command_line_args.local_dir
        # was os.getenv('SANITY_REPORT_DIR')
        self.report_path = self.command_line_args.report_path
        # was os.getenv('REPORT_TEMPLATE')
        self.report_template = self.command_line_args.report_template
        ...
        # os.getenv('TEST_RUN_PREFIX')
        self.testRunPrefix = self.command_line_args.testrail_run_prefix
        ...
        # EAP Credentials
        # was os.getenv('EAP_IDENTITY')
        self.identity = self.command_line_args.eap_id
